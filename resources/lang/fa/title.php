...
return [
    ...
    'stock' => 'موجودی',
    'log' => 'تاریخچه تغییرات',
    'can_order' => 'قابل سفارش',
    'available' => 'موجود',
    'postal_code' => 'کد پستی',
    'buy_item' => ' اضافه به سبد خرید  ',
    'basket' => 'سبد خرید',
    'sum' =>'مجموع',
    'post_price' => 'مبلغ مورد نیاز جهت ارسال محصول از طریق پست را وارد کنید',
    'card_number' => 'شماره کارت بانکی',
    'card_owner' => 'به اسم صاحب حساب ',
    'card'=> 'شماره کارت بانکی',
    'postal' => 'کد پستی',
    'address_delivery' => 'آدرس محل تحویل ',
    'count' => 'تعداد',
    ...
    'seller' => 'فروشنده',
    'shopper' => 'خریدار',
    'meta_description' => 'در این وبسایت می توان محصولات خانگی را ببینید یا بخرید یا بفروشید . کمک به کسب و کار خانگی  ',
    'meta_keyword' => 'کسب و کارخانگی , بافتنی , خیاطی , منبت , تابلو , شیرینی خانگی , نمونه طراحی سایت  '
