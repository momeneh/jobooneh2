...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!-- CSS -->
        @if(app()->getLocale() == 'fa')
            <link href="{{ asset('white') }}/css/fa.css?v=1.0.0" rel="stylesheet" />
        @else
            <link href="{{ asset('white') }}/css/en.css?v=1.0.0" rel="stylesheet" />
        @endif
    ...
    <body class="white-content {{ $class ?? '' }}" STYLE="direction:
        ...
        @auth()
            <div class="wrapper">
                ...
                @endif
                @if(app()->getLocale() == 'fa')
                    <div class="main-panel" style=" margin-right:220px">
                @else
