                ...
                <div class="flex-center position-ref full-height">
                    ...
                    <form action="{{route($prefix.'message.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group{{ $errors->has('receiver') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="auto" type="text" class="ui-autocomplete-input form-control" route = "{{route($prefix.'autocompleteReceiver')}}" autocomplete="off"  name="receiver" value="{{ old('receiver') }}" required autofocus>
                                <input id="auto_id" type="text" class="hidden"  autocomplete="off"  name="receiver_id" value="{{ old('receiver_id') }}"  >
                        ...
                        <div class="col-xs-10">
                            ...
                            <div id="msgBox"></div>
                            <button type="button" id="uploadBtn" class="btn btn-large btn-primary" style="{{!empty(old('image' )) ? 'display: none;'  : '' }}" >Choose File</button>
                            <button type="button" id="removeBtn" class="btn btn-large btn-primary " style="{{empty(old('image' )) ? 'display: none;'  : '' }}" >Remove</button>
                        </div>
